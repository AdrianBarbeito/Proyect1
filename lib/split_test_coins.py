...
if __name__ == '__main__':
    ...
    'cVeJsTA9iDro6BQBL73HeKTr9g3T1axN788QPAynvbvfctVuXqDQ')

    public_key = private_key.pub
    address = P2PKHBitcoinAddress.from_pubkey(public_key)

    amount_to_send = 0.014947-0.0005 # amount of BTC in the output you're splitting minus fee
    txid_to_spend = (
        'e8d4156a6cd819f446008401fa6e666b37d003ae8431b3624e01b98fadaabd0d')
